<template>
  <div>
    ...
    <trashed-message v-if="role.deleted_at" class="mb-6" @restore="restore"> This product has been deleted. </trashed-message>
    <div class="max-w-7xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="update">
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          ...
          <select-input v-model="form.category_id" :error="form.errors.category_id" class="pt-8 pb-8 pr-6 w-full lg:w-1/2" label="Category">
